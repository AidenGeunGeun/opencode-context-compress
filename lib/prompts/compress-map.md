...
Use it at the start of context management or any time you want a fresh snapshot. The map does not mark an active tail for you; decide what to leave uncompressed from the conversation itself.
