...
export const COMPRESS_MAP = `Use this tool only during a current manual or plugin-initiated automatic compression-management turn. The user or plugin must open that turn; the model cannot create compression authority itself.
