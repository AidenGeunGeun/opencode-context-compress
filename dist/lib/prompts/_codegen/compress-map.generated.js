...
export const COMPRESS_MAP = `Use this tool as a fallback during a user-initiated \`/compress manage\` turn to fetch the current compression map. The current \`<compress-context-map>\` snapshot is normally already provided with the manage reminder, so this tool is not needed in the ordinary path.
