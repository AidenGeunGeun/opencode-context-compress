...
export const COMPRESS = `Do not call this tool autonomously. Tool availability alone is not authorization. Call it only when the current turn contains either a manual/plugin-initiated compression-management reminder or an explicit user request in the current message to compress context.
