...
// Generated from squash.md by scripts/generate-prompts.ts
// To modify, edit squash.md and run `npm run generate:prompts`
export const SQUASH = `Do not call this tool autonomously. Tool availability alone is not authorization. Call it only inside the still-active management turn created by the current user's \`/compress squash\` command; runtime authorization fails closed otherwise.
...
`;
//# sourceMappingURL=squash.generated.js.map